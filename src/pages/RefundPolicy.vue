...
<template>
    ...
    <div style="padding: 20px;">
        ...
        <ul>
            ...
            <li>Free-trial conversions.</li>
        </ul>

        <h2>4. Requesting a Refund</h2>
        <p>Contact us at: contact@vetcho.org (Include your account email and transaction details).</p>

        <h2>5. Processing Time</h2>
        <p>Approved refunds are processed within 5-10 business days via the original payment method.</p>
    </div>
